package com.example3.base.config;
...
public class FileTransferConfig { 
	...
	@Bean
	public ConsumerFactory<String, TransferRequestPayload> fileTransferKafkaConsumerFactory() {
	...
	@Bean
	public ProducerFactory<String, TransferRequestPayload> fileTransferKafkaProducerFactory() {
	...
	@Bean
	public KafkaTemplate<String, TransferRequestPayload> fileTransferKafkaTemplate(
		ProducerFactory<String, TransferRequestPayload> fileTransferKafkaProducerFactory
	) {
		return new KafkaTemplate<>(fileTransferKafkaProducerFactory); 
	}
